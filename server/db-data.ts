...
export const ABSENSE_REASONS = {
    id: 'absence_reasons',
    data: [
        { name: 'ADVANCED_EDUCATION'},
        { name: 'EDUCATION'},
        { name: 'HOLIDAY'},
        { name: 'OVERTIME_REDUCTION' },
        { name: 'SICKNESS' },
        { name: 'UNEXCUSED' }
    ],
    default: { name: 'HOLIDAY'}
};

export const PEOPLE_ABSENSES = {
    id: 'people_absences',
    data: {
        employees: [
            {
                ...
                events: [
                    {
                        dateFrom: '2018-12-04',
                        dateUntil: '2018-12-13',
                        allDay: true,
                        reason: 'HOLIDAY'
                    },
                    {
                        dateFrom: '2018-12-07',
                        dateUntil: '2018-12-07',
                        allDay: true,
                        reason: 'SICKNESS'
                    }
                ]
